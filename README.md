...
- [General - Server Settings](https://github.com/Sinc0/TypescriptCountriesRestAPI/blob/master/app.ts#L29-L40)
- [General - Database Connection](https://github.com/Sinc0/TypescriptCountriesRestAPI/blob/master/app.ts#L43-L46)
###
- [Message - Help](https://github.com/Sinc0/TypescriptCountriesRestAPI/blob/master/modules/functions.ts#L30-L68)
...
###
- [Token - Create](https://github.com/Sinc0/TypescriptCountriesRestAPI/blob/master/modules/functions.ts#L192-L207)
- [Token - Validate](https://github.com/Sinc0/TypescriptCountriesRestAPI/blob/master/modules/functions.ts#L209-L249)
- [Token - Usage](https://github.com/Sinc0/TypescriptCountriesRestAPI/blob/master/modules/functions.ts#L251-L309)
- [Token - Calculate Expiration](https://github.com/Sinc0/TypescriptCountriesRestAPI/blob/master/modules/functions.ts#L315-L333)